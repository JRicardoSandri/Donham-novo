<!-- Versao em texto do trabalho. O documento formatado (Times New Roman 12, margens 2,5 cm, entrelinhas 1,5) e o arquivo Gerenciamento-de-Crises-PMDF.docx -->

POLÍCIA MILITAR DO DISTRITO FEDERAL

DEPARTAMENTO DE EDUCAÇÃO E CULTURA

GERENCIAMENTO DE CRISES NA POLÍCIA MILITAR DO DISTRITO FEDERAL:

fundamentos doutrinários, marco normativo e aplicação operacional
...
Palavras-chave: Gerenciamento de crises. Negociação policial. Uso diferenciado da força. Polícia Militar do Distrito Federal. Direitos humanos.
...
## 2 REFERENCIAL DOUTRINÁRIO DO GERENCIAMENTO DE CRISES


### 2.1 Origem e evolução da doutrina
...
### 2.2 Conceito e características essenciais da crise
...
### 2.3 Objetivos e critérios de ação
...
## 3 MARCO NORMATIVO E O USO DIFERENCIADO DA FORÇA


### 3.1 Fundamento constitucional e legal da atuação da PMDF
...
### 3.2 O regime jurídico do uso da força
...
### 3.3 Excludentes de ilicitude e a proteção do policial que atua em crise
...
## 4 A ORGANIZAÇÃO DA RESPOSTA: TEATRO DE OPERAÇÕES E PROCESSO DECISÓRIO


### 4.1 Primeiras providências: conter, isolar e negociar
...
### 4.2 O teatro de operações e seus perímetros
...
### 4.3 Fases do processo de gerenciamento
...
### 4.4 A graduação do risco

A doutrina classifica os eventos críticos segundo graus crescentes de risco, escala que orienta o nível de acionamento, a composição dos meios e o eventual envolvimento de outras instituições. O Quadro 1 sintetiza essa graduação.

Quadro 1 – Graus de risco dos eventos críticos

| Grau | Denominação | Caracterização e exemplos típicos |
|---|---|---|
| 1 | Alto risco | Evento com ameaça concreta à vida, sem sofisticação de meios: tentativa de suicídio, indivíduo barricado sem reféns, roubo frustrado com vítima detida no local. |
| 2 | Altíssimo risco | Presença de reféns localizados, causador armado e com disposição de resistir; exige negociação estruturada e grupo tático em prontidão. |
| 3 | Ameaça extraordinária | Motivação política, ideológica ou terrorista; múltiplos causadores; artefatos explosivos; alvos simbólicos ou autoridades. |
| 4 | Ameaça exótica | Emprego ou ameaça de emprego de agentes químicos, biológicos ou radiológicos; sabotagem de infraestrutura crítica. |
| 5 | Ameaça limite | Ameaça de emprego de artefato nuclear ou de evento com potencial de dano catastrófico e irreversível. |

Fonte: elaborado pelo autor com base no material de apoio do curso e na doutrina nacional de gerenciamento de crises.

A classificação não é mero exercício acadêmico. Dela decorrem consequências operacionais imediatas: a partir do terceiro grau, a resolução do evento tende a exigir articulação com órgãos federais, ativação de gabinete de gestão integrada e assessoramento jurídico permanente. No Distrito Federal, essa hipótese é mais provável do que em qualquer outra unidade da Federação, dada a presença de alvos simbólicos de significado nacional.


### 4.5 As alternativas táticas

Definido o quadro, o gerente da crise dispõe de quatro alternativas táticas, ordenadas segundo o risco crescente que representam para a vida das pessoas envolvidas. O Quadro 2 apresenta suas características.

Quadro 2 – Alternativas táticas em ordem crescente de risco

| Alternativa tática | Características, requisitos e riscos |
|---|---|
| Negociação | Alternativa preferencial e permanente. Baixo risco para todos os envolvidos, custo operacional reduzido e reversibilidade integral. Acompanha todas as demais alternativas, jamais sendo por elas substituída de forma definitiva. |
| Emprego de técnicas e instrumentos de menor potencial ofensivo | Uso de agentes químicos, munições de impacto controlado, dispositivos de incapacitação neuromuscular e recursos de distração. Exige treinamento certificado, avaliação de risco à saúde de reféns e terceiros e observância da Lei nº 13.060/2014. |
| Tiro de comprometimento | Disparo de precisão executado por atirador de elite, mediante autorização expressa do gerente da crise, quando presente risco atual ou iminente à vida da vítima. Requer posição consolidada, identificação inequívoca do alvo e leitura precisa do ambiente. |
| Invasão tática | Alternativa de maior risco e de menor reversibilidade. Somente se justifica quando as demais se mostrarem inviáveis ou insuficientes, exigindo planejamento, ensaio em maquete ou instalação similar e apoio de saúde previamente posicionado. |

Fonte: elaborado pelo autor com base no material de apoio do curso e na legislação de regência.
...
## 5 A NEGOCIAÇÃO COMO ALTERNATIVA TÁTICA PREFERENCIAL
...
## 6 CONTROLE, JURISPRUDÊNCIA E RESPONSABILIZAÇÃO
...
## 7 CONTEXTUALIZAÇÃO COM A ATIVIDADE OPERACIONAL E ADMINISTRATIVA DA PMDF


### 7.1 Particularidades do Distrito Federal
...
### 7.2 Casos ilustrativos e lições aprendidas
...
### 7.3 A dimensão administrativa do gerenciamento de crises
